...
Además, instalaremos la librería `jogRu` desde github.
...
```{r }
# data <- read_csv("C:/Users/danie/Downloads/Actividad_en_R_2/input/data/data.csv") # Cargar base de datos
...
En estos datos podemos ver una serie de ítems que corresponden a diferentes dimensiones de la escala. De acuerdo con el paper, los ítems se ordenan de esta forma de acuerdo con los tipos de humor:
