...
La siguiente práctica tiene el objetivo de introducir la idea central del análisis de correspondencia. Por esta razón. Para ello, utilizaremos la base de datos de la cuarta ola del Estudio Longitudinal Social del Chile 2019 con el objetivo de analizar agrupaciones de variables categóricas nominales.
