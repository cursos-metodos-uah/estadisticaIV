...
```{r }
load(url("https://github.com/cursos-metodos-facso/investigacion-cuantitativa/raw/main/files/data/ELSOC_Long_2016_2022_v1.00.RData")) #Cargar base de datos
```
