...
.pull-right-wide[
.center[![:scale 100%](../../files/img/casen2016.png)]
]
---
class: inverse, bottom, right
...
* Medida unidimensional de una serie de categorías ordenadas que se utilizan para medir o calificar un atributo específico
